// Adapted from rust-by-example/conversion/string.md (see ../NOTICES.md).
...
#evcxr.rust-main(id: "rbe-conversion-string-to", ```rust
use std::fmt;
...
#evcxr.rust-main(id: "rbe-conversion-string-parse", ```rust
fn main() {
...
#evcxr.rust-main(id: "rbe-conversion-string-fromstr", ```rust
