// Adapted from rust-by-example/hello/print/fmt.md (see ../../NOTICES.md).
...
#evcxr.rust-main(id: "rbe-hello-print-fmt", ```rust
...
- You can pad with zeros to a width of 2 with `:0>2`. For hexadecimals, you can use `:02X`.
