// Adapted from rust-by-example/types/alias.md (see ../NOTICES.md).
...
#evcxr.rust-main(id: "rbe-types-alias", ```rust
...
fn main() {
    ...
    // Note that type aliases _don't_ provide any extra type safety, because
    // aliases are _not_ new types
